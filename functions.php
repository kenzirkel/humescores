...
function humescores_setup() {
    ...
    add_image_size( 'humescores_full_bleed', 2000, 1200, true);
...
function humescores_widgets_init() {
    ...
    register_sidebar( array(
		'name'          => esc_html__( 'Footer Widget', 'humescores' ),
		'id'            => 'footer-1',
...
function humescores_scripts() {
	...
	wp_enqueue_script( 'humescores-functions', get_template_directory_uri() . '/js/functions.js', array('jquery'), '20170910', true ); 
